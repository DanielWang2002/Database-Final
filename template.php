      ...
      <div class='scroll-sidebar'>
        ...
        <nav class='sidebar-nav'>
          ...
          <a
            ...
            ><span class='hide-menu'>基本資料管理 </span></a
          >
          <ul aria-expanded='false' class='collapse first-level'>
            <li class='sidebar-item'>
              <a href='dept.php' class='sidebar-link'
                ><i class='mdi mdi-note-outline'></i><span class='hide-menu'> 部門管理  </span></a>
            </li>
            <li class='sidebar-item'>
              <a href='form-wizard.html' class='sidebar-link'
                ><i class='mdi mdi-note-plus'></i
                ><span class='hide-menu'> 員工管理 </span></a
              >
            </li>
            <li class='sidebar-item'>
            <a href='form-wizard.html' class='sidebar-link'
              ><i class='mdi mdi-note-plus'></i
              ><span class='hide-menu'> 產品管理 </span></a
            >
          </li>
